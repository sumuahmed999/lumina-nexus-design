...
const featuredProjects = [
  {
    ...
    description: "AI-powered analytics platform with real-time data visualization and machine learning insights. Built with advanced algorithms for predictive analysis.",
  ...
  },
  {
    id: 4,
    title: "AR Shopping",
    description: "Immersive augmented reality e-commerce platform for furniture visualization.",
  ...
  },
  {
    id: 6,
    title: "Design System",
    description: "Comprehensive design system with reusable components and accessibility features.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ParallaxSection speed={0.2} className="text-center mb-12 sm:mb-16 lg:mb-20">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-sm font-mono text-accent uppercase tracking-wider">Featured Work</span>
            <Sparkles className="w-6 h-6 text-accent animate-pulse" />
          </div>
          ...
          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A curated selection of innovative solutions and creative implementations that showcase 
            the intersection of design and technology
          </p>
        </ParallaxSection>

        {/* Projects Grid */}
        <ParallaxSection speed={0.1} className="mb-12 sm:mb-16 lg:mb-20">
