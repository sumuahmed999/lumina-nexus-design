...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden perspective-2000 pt-16 md:pt-20">
      ...
      <AnimatedBlob size="lg" color="primary" position={{ x: 20, y: 30 }} delay={0} speed="slow" />
      <AnimatedBlob size="md" color="secondary" position={{ x: 80, y: 20 }} delay={1.5} speed="normal" />
      <AnimatedBlob size="sm" color="accent" position={{ x: 15, y: 70 }} delay={3} speed="fast" />
      <AnimatedBlob size="md" color="primary" position={{ x: 85, y: 80 }} delay={2} speed="slow" />
      <AnimatedBlob size="lg" color="accent" position={{ x: 50, y: 90 }} delay={0.5} speed="normal" />
      
      {/* Floating 3D Geometric Elements */}
      <FloatingGeometry type="cube" size="sm" color="primary" position={{ x: 10, y: 20 }} delay={0} />
      <FloatingGeometry type="sphere" size="sm" color="secondary" position={{ x: 85, y: 15 }} delay={1} />
      <FloatingGeometry type="pyramid" size="sm" color="accent" position={{ x: 15, y: 70 }} delay={2} />
      <FloatingGeometry type="torus" size="md" color="primary" position={{ x: 80, y: 75 }} delay={3} />
      
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-8rem)]">
          
          {/* Profile Picture Side */}
          <ParallaxSection speed={0.2} className="flex justify-center lg:justify-end order-1 lg:order-1">
          ...
          {/* Content Side */}
          <ParallaxSection speed={0.3} className="text-center lg:text-left order-2 lg:order-2">
            <div className="space-y-6 sm:space-y-8 lg:space-y-10">
              ...
              <div className="relative overflow-hidden">
                <h2 className={`text-lg sm:text-xl md:text-2xl lg:text-3xl font-heading font-medium text-muted-foreground transition-all duration-1000 delay-300 leading-relaxed ${
                  textRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}>
              ...
              <p className={`text-base sm:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 transition-all duration-1000 delay-500 leading-relaxed ${
                textRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}>
              ...
              <div className={`flex flex-col sm:flex-row gap-4 lg:gap-6 justify-center lg:justify-start items-center mt-8 lg:mt-12 transition-all duration-1000 delay-700 ${
                textRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}>
              ...
              {/* Stats Section */}
              <div className={`grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-12 lg:mt-16 transition-all duration-1000 delay-900 ${
                textRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}>
                {[
                  ...
                  <div key={index} className="text-center p-3 lg:p-4 holographic rounded-lg hover-lift">
      ...
      <ParallaxSection speed={0.8} className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 z-20">
